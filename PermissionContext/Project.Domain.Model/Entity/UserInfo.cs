...
namespace ProjectCore.Domain.Model.Entity
{
    ...
    public class UserInfo : IAggregationRoot, ISoftDelete
    {
        ...
        /// 创建用户
        /// </summary>
        public UserInfo CreateUser(string userName, string userPassword, string userPhone, Address address, Guid createUserId, string createUserName)
        {
            return new UserInfo(userName, userPassword, userPhone, address, createUserId, createUserName);
        }
